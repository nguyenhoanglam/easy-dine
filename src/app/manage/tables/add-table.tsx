...
import { useCreateTableMutation } from "@/queries/table";
...
export default function AddTable() {
  ...
  const form = useForm<CreateTableReqBody>({
  ...
  const onSubmit = async (data: CreateTableReqBody) => {
    const response = await createTableMutation.mutateAsync(data);
